...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Singing Bowl', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'PHD in ZJU  ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://singingbowl.blog', // 网站地址
